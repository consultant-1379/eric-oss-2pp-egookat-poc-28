...
This is a repo to test functionality of new repo script and see if new Java projects get added to 2pp list artifacts are stored in the Gerrit project: [OSS/com.ericsson.oss.ci.test/eric-oss-2pp-egookat-poc-28](https://gerrit.ericsson.se/#/admin/projects/OSS/com.ericsson.oss.ci.test/eric-oss-2pp-egookat-poc-28)
  
### Documents

The documentation for this service is located in the [doc folder](https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-2pp-egookat-poc-28/+/master/doc).

To update documents that are not in the referenced folder, contact the service guardians mentioned in the [README.md](https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-2pp-egookat-poc-28/+/master/README.md).
...
The code-review scores and corresponding workflow activities are as follows:
   ...
   [README.md] (https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-2pp-egookat-poc-28/+/master/README.md)