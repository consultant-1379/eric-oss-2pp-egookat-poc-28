...
*/ -}}
{{- define "eric-oss-2pp-egookat-poc-28.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-2pp-egookat-poc-28.mergeAnnotations" -}}
  {{- include "eric-oss-2pp-egookat-poc-28.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-2pp-egookat-poc-28.mergeLabels" -}}
  {{- include "eric-oss-2pp-egookat-poc-28.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
